        ...
        <div className="prose prose-gray max-w-none space-y-6 text-foreground">
          ...
          <section>
            ...
            <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-xl p-4 text-muted-foreground">
              ...
              <p className="leading-relaxed">
                The lawn care diagnoses, treatment recommendations, and other information provided by Lawn Guardian are generated by artificial intelligence and are for <strong>educational and informational purposes only</strong>. While we strive for accuracy using industry-leading AI technology (Plant.id API), we cannot guarantee that AI-generated diagnoses will be 100% correct.
              </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mt-3">
              ...
              <li><strong>AI Services:</strong> Plant.id API for plant identification</li>
